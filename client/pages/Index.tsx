          ...
          <div className="text-center space-y-12">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
              ...
              <Button variant="outline" size="lg" asChild className="group border-2 border-primary/20 hover:border-primary hover:bg-primary/5 dark:hover:bg-primary/10 transition-all duration-300 hover:scale-105">
                <a href="mailto:avis28134@gmail.com?subject=Let's Connect&body=Hi Aditya,%0D%0A%0D%0AI'd love to connect with you!" className="flex items-center">
                  Get In Touch
            ...
            <div className="flex justify-center space-x-8">
              ...
              <a
                href="https://www.linkedin.com/in/aditya-singh-891bb91b4/"
                target="_blank"
                rel="noopener noreferrer"
            ...
            <Card className="group relative overflow-hidden bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm border-0 shadow-lg hover:shadow-2xl transition-all duration-500 hover:scale-105 hover:-translate-y-2">
              ...
              <CardContent className="relative p-8 text-center space-y-6">
                ...
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-400 text-sm mb-3">avis28134@gmail.com</p>
                  <Button variant="link" className="p-0 h-auto font-medium text-primary hover:text-primary/80 group/btn" asChild>
                    <a href="mailto:avis28134@gmail.com?subject=Let's Connect&body=Hi Aditya,%0D%0A%0D%0AI'd love to connect with you!" className="flex items-center justify-center">
                      Send Email
            ...
            <Card className="group relative overflow-hidden bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm border-0 shadow-lg hover:shadow-2xl transition-all duration-500 hover:scale-105 hover:-translate-y-2">
              ...
              <CardContent className="relative p-8 text-center space-y-6">
                ...
                <div>
                  ...
                  <Button variant="link" className="p-0 h-auto font-medium text-primary hover:text-primary/80 group/btn" asChild>
                    <a href="https://www.linkedin.com/in/aditya-singh-891bb91b4/" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center">
                      Connect
                      <ExternalLink className="ml-1 h-4 w-4 group-hover/btn:translate-x-0.5 transition-transform duration-200" />
                    </a>
                  </Button>
            ...
            <Card className="group relative overflow-hidden bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm border-0 shadow-lg hover:shadow-2xl transition-all duration-500 hover:scale-105 hover:-translate-y-2">
              ...
              <CardContent className="relative p-8 text-center space-y-6">
                ...
                <div>
                  ...
                  <Button variant="link" className="p-0 h-auto font-medium text-primary hover:text-primary/80 group/btn" asChild>
                    <a href="https://github.com/Aditya-Singh-16" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center">
                      Follow
                      <ExternalLink className="ml-1 h-4 w-4 group-hover/btn:translate-x-0.5 transition-transform duration-200" />
                    </a>
                  </Button>
